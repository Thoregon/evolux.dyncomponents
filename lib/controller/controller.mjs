...
export default class Controller {
    ...
    async install(path, loader) {
        ...
        try {
            ...
            if (descriptor.oninstall && isFunction(descriptor.oninstall)) descriptor.oninstall(descriptor);
    ...
    async uninstall(componentID) {
        ...
        try {
            ...
            if (context.oninstall && isFunction(context.onuninstall)) context.onuninstall(context);
    ...
    async update(componentID) {
        ...
        try {
            ...
            if (context.onupdate && isFunction(context.onupdate)) context.onupdate(context);
    ...
    async resolve(componentID) {
        ...
        try {
            ...
            if (context.onresolve && isFunction(context.onresolve)) context.onresolve(context);
    ...
    async start(componentID) {
        ...
        try {
            ...
            if (context.onstart && isFunction(context.onstart)) context.onstart(context);
    ...
    async stop(componentID) {
        ...
        try {
            ...
            if (context.onstop && isFunction(context.onstop)) context.onstop(context);
            context.status.stop();
