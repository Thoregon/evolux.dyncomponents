 ...
 * todo: don't install components directly, use 'matter.components' (ComponentListener) to ensure distribution
 *
 * @author: blukassen
 */
...
export default class LocationWatcher extends ControllerPlugin {
    ...
    async _foundComponent(path) {
        ...
        if (!id) {
            // was not installed
            controller.logger.error(`LocationWatcher: Component '${path}' was not installed`);
            return;
        }
