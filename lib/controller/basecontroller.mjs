...
export default class BaseController extends RepoMirror(Reporter(EventEmitter), 'components') {
    ...
    async install(path, loader) {
        ...
        try {
            this.logger.info("install 1 >", componentid, thoregon.since);
            ...
            this.logger.info("install 2 >", componentid, thoregon.since);
            ...
            this.logger.info("install 3 >", componentid, thoregon.since);
            ...
            this.logger.info("install 4 >", componentid, thoregon.since);
            ...
            this.logger.info("installed >", componentid, thoregon.since);
