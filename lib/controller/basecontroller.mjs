...
export default class BaseController extends Reporter(EventEmitter) {
    ...
    async install(path, loader) {
        ...
        try {
            ...
            if (!this.hasOwnProperty(componentid)) this[componentid] = context.component;   // shortcut for easy access
    ...
    async uninstall(componentID) {
        ...
        try {
            ...
            if (this.hasOwnProperty(componentID)) delete this[componentID];
    ...
    isInstalled(id) {
        return this._isStatus(id, 'installed');
    }

    isStarted(id) {
        return this._isStatus(id, 'started');
    }
