...
export class ComponentContext {
    ...
    constructor({
        ...
        Object.assign(this, { id, displayName, category, description, version, href, dependencies, optional, oninstall, onresolve, onstart, onstop, onuninstall, status: null, module: null });
    }

    get isService() {
        return this.component && isService(this.component.default);
    }
